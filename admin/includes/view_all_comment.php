<table class="table table-bordered table-hover">
    ...
    <tbody>
           ...
           $sql = "SELECT * FROM comments WHERE comment_author ='{$user}' ORDER BY comment_id ASC"; //displaying the categories from the database to the table
...
while($row =  mysqli_fetch_assoc($check) ){
    ...
    echo "<td><a class='btn btn-info' href='comment.php?unapprove=$comment_id'> Unapprove </a></td>";
    echo "<td><a class='btn btn-danger' onClick=\"javascript: return confirm('are you sure you want to delete');\" href='comment.php?delete=$comment_id'> Delete </a></td>";
